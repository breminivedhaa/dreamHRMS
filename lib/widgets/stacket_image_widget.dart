...
class StackedWidgets extends StatelessWidget {
  ...
  const StackedWidgets({
    ...
    this.size = 100,
    this.xShift = 20, required this. showCount,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final allItems = items
        ...
        .map((index, item) {
          ...
          final value = index+1==items.length && showCount==true?
          Container(
            width: size,
            height: size,
            child: Container(
...
Widget buildStackedImages({
  TextDirection direction = TextDirection.ltr,double? imgsize, required bool showCount
}) {
