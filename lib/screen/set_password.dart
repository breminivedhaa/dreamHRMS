        ...
        children: [
          ...
          CommonTextFormField(
            ...
            validator: (String? data) {
              if (data == "" || data == null) {
                return "validate_new_password".i18n();
              } else {
                return null;
              }
            },
          ...
          CommonTextFormField(
            ...
            validator: (String? data) {
              if (data == "" || data == null) {
                return "validate_confirm_password".i18n();
              } else {
                return null;
              }
            },
    ...
    return Center(
      child: Column(
        children: [
          ...
          SizedBox(height: 30),
          CustomText(
              text: "set_password".i18n(),
              color: AppColors.black,
              fontSize: 25,
              fontWeight: FontWeight.w700),
          SizedBox(height: 10),
          CustomText(
              text: "set_password_message".i18n(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          CustomText(
              text: "reset_password_success_msg".i18n(),
              color: AppColors.black,
              fontSize: 20,
              textAlign: TextAlign.center,
              fontWeight: FontWeight.w700),
